...
class ServiceBehavior extends BaseBehavior {
    ...
    public function getModels_ServiceAdd() {
        return array(
            'console\models\base\InitData_BaseProduct' => 'serviceAdd',
    ...
    public function getModels_ServiceEdit() {
        return array(
            'console\models\base\InitData_BaseProduct' => 'serviceEdit',
    ...
    public function getModels_ServiceDelete() {
        return array(
            'console\models\base\InitData_BaseProduct' => 'serviceDelete',
    ...
    public function getModels_ServiceDesc() {
        return array(
            'console\models\base\List_BaseProduct' => "serviceDesc"
        );
    }   
